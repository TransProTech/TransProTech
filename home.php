    ...
    <div class="row justify-content-center g-4 mt-4">
      ...
      <div class="col-md-4 d-flex justify-content-center">
        <div class="box text-start">
          ...
          <div class="alerts">
            <div>Ongoing Checkpoint in Darasa</div>
            <div>Jeepney Route changed due to accident</div>
            <div>Ongoing Roadworks in Sta Maria Sto Tomas</div>
          </div>
