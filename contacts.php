...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<script>alert('Thank you for using TransProTech!'); window.location.href='contacts.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
...
<head>
  <meta charset="UTF-8">
  <title>TransProTech - Feedback</title>
...
<div class="contact-container">
  <h2 class="mb-4 fw-semibold text-center text-primary">Send Feedbacks</h2>

  <div class="row">
    <div class="col-md-5 contact-info">
      <h5>Head Office</h5>
      <p>TransProTech Inc.<br>Tanauan City, Batangas, Philippines</p>
      <h5>Email</h5>
      <p><a href="mailto:support@transpro.com">support@transprotech.com</a></p>
      <h5>Phone</h5>
      <p>+63 912 345 6789</p>
      <h5>Working Hours</h5>
